<?php
// [prt-social-links]
if( !function_exists('preyantechnosys_sc_social_links') ){
function preyantechnosys_sc_social_links( $atts, $content=NULL ){
	...
	$wrapperStart = '<div class="preyantechnosys-social-links-wrapper">';
	$wrapperEnd   = '</div>';
	return $wrapperStart . preyantechnosys_get_social_links($tooltip_position, $tooltip) . $wrapperEnd;
}
}
add_shortcode( 'prt-social-links', 'preyantechnosys_sc_social_links' );
 ...
 */
if( !function_exists('preyantechnosys_get_social_links') ){
function preyantechnosys_get_social_links( $tooltip_position='top' , $tooltip='yes' ){
	...
	if( !empty($minemo_theme_options['social_icons_list']) ){
		foreach( $minemo_theme_options['social_icons_list'] as $socialicon ){
			...
			$return .= '<li class="prt-social-' . $social_id . '"><a class=" ' . sanitize_html_class($class) . '" target="_blank" href="' . $href . '" ' . $data_tooltip . '><i class="prt-minemo-icon-' . $social_id . '"></i>' . $social_id . '</a></li>' . "\n";
