<?php
// [prt-preyantechnosysiconseparator icon="search-1" style="dashed" width="70" el_class="customclass"]
if( !function_exists('preyantechnosys_sc_icon_separator') ){
function preyantechnosys_sc_icon_separator( $atts, $content=NULL ){
	...
	if( function_exists('vc_map') ){
		...
		$options_list = preyantechnosys_create_options_list($tm_sc_params_icon_separator);
		...
		$icon = '<i class="prt-separatoc-icon '.${'icon_icon_'.$icon_type}.'"></i>';
		...
		// Separator
		$separator_code = '<div class="prt-sep-with-icon-wrapper">';
...
add_shortcode( 'prt-icon-separator', 'preyantechnosys_sc_icon_separator' );