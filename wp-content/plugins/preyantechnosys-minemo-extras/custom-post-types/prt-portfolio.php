...
function preyantechnosys_minemo_cpt_tm_portfolio(){

	$minemo_theme_options = get_option('minemo_theme_options');
	
	$pf_type_title          = ( !empty($minemo_theme_options['pf_type_title']) ) ? $minemo_theme_options['pf_type_title'] : 'Portfolio' ;
	...
	$pf_type_slug           = ( !empty($minemo_theme_options['pf_type_slug']) ) ? $minemo_theme_options['pf_type_slug'] : 'portfolio' ;
	
	$pf_cat_title          = ( !empty($minemo_theme_options['pf_cat_title']) ) ? $minemo_theme_options['pf_cat_title'] : 'Portfolio Categories' ;
	$pf_cat_title_singular = ( !empty($minemo_theme_options['pf_cat_title_singular']) ) ? $minemo_theme_options['pf_cat_title_singular'] : 'Portfolio Category' ;
	$pf_cat_slug           = ( !empty($minemo_theme_options['pf_cat_slug']) ) ? $minemo_theme_options['pf_cat_slug'] : 'portfolio-category' ;
...
add_action( 'init', 'preyantechnosys_minemo_cpt_tm_portfolio', 8 );
...
add_filter( 'manage_tm_portfolio_posts_columns', 'preyantechnosys_tm_portfolio_set_featured_image_column' );
add_action( 'manage_tm_portfolio_posts_custom_column' , 'preyantechnosys_tm_portfolio_set_featured_image_column_content', 10, 2 );
if ( ! function_exists( 'preyantechnosys_tm_portfolio_set_featured_image_column' ) ) {
function preyantechnosys_tm_portfolio_set_featured_image_column($columns) {
	$new_columns = array();
...
if ( ! function_exists( 'preyantechnosys_tm_portfolio_set_featured_image_column_content' ) ) {
function preyantechnosys_tm_portfolio_set_featured_image_column_content( $column, $post_id ) {
 ...
 */
if ( ! function_exists( 'preyantechnosys_minemo_tm_portfolio_metabox_options' ) ) {
function preyantechnosys_minemo_tm_portfolio_metabox_options( $options ) {
	...
	$list_array    = array();
	$options_array = array();
	if( isset($minemo_theme_options['pf_details_line']) && is_array($minemo_theme_options['pf_details_line']) && count( $minemo_theme_options['pf_details_line'] ) > 0 ){
		foreach( $minemo_theme_options['pf_details_line'] as $key=>$val ){
			
			$option_array = array(
				'id'         => 'pf_details_line_'.$key,
				'type'       => 'text',
				'title'      =>esc_attr__($val['pf_details_line_title'], 'minemo'),
			);
			...
			switch( $val['data'] ){
				...
				case 'category' :
					$option_array['type']       = 'text';
					$option_array['attributes'] = array( 'readonly'  => 'only-key' );
					$option_array['wrap_class'] = 'prt-input-style-text';
				...
				case 'category_link' :
					$option_array['type']       = 'text';
					$option_array['attributes'] = array( 'readonly'  => 'only-key' );
					$option_array['wrap_class'] = 'prt-input-style-link';
					$option_array['value']      = strip_tags( get_the_term_list( $post_id, 'tm_portfolio_category', '', ', ', '' ) );
					break;
	...
	$options[]    = array(
		'id'        => 'preyantechnosys_portfolio_list_data',
		'title'     => sprintf( esc_attr__('Minemo: %s List Options', 'tmte'), $pf_type_title_singular ),
		'post_type' => 'tm_portfolio', // only here is important
		'context'   => 'normal',
		'priority'  => 'default',
		'sections'  => array(
			array(
				'name'   => 'preyantechnosys_pf_list_data',
				'fields' => array(
					...
					array(
						...
						"type"  => "text",
						"title" => '<span class="prt-admin-team-list-icon"></span> &nbsp; '.__('View Project Button Text', 'tmte'),
					),
					array(
						"id"    => "project_details_line_btn_link",
						"type"  => "text",
						"title" => '<span class="prt-admin-team-list-icon"></span> &nbsp; '.__('View Project Button Link', 'tmte'),
					),	
				),
			),
		),
	...
	$options[]    = array(
		'id'        => 'preyantechnosys_portfolio_featured',
		'title'     => esc_attr__('Minemo: Featured Image / Video / Slider', 'tmte'),
		'post_type' => 'tm_portfolio', // only here is important
		'context'   => 'normal',
		'priority'  => 'default',
		'sections'  => array(
			array(
				'name'   => 'preyantechnosys_pf_featured',
				'fields' => array(
					...
					array(
						...
						'options'       => array(
											...
											'multiimage'	  => esc_attr__('Multi Image', 'tmte'),
										),
						'default'		=> 'image',
					...
					array(
						'id'          => 'multiimage_one',
						'type'        => 'image',
						'title'       => esc_attr__('Images One', 'tmte'),
						'add_title'   => 'Add Images',
						'edit_title'  => 'Edit Images',
						'clear_title' => 'Remove Images',
						'dependency'  => array( 'featuredtype_multiimage', '==', 'true' ),
						'after'       => '<br><div class="cs-text-muted">'.__('Select 1st image', 'tmte').'</div>',
					),
					array(
						'id'          => 'multiimage_two',
						'type'        => 'image',
						'title'       => esc_attr__('Images Two', 'tmte'),
						'add_title'   => 'Add Images',
						'edit_title'  => 'Edit Images',
						'clear_title' => 'Remove Images',
						'dependency'  => array( 'featuredtype_multiimage', '==', 'true' ),
						'after'       => '<br><div class="cs-text-muted">'.__('Select 2nd image', 'tmte').'</div>',
					),
					array(
						'id'          => 'multiimage_three',
						'type'        => 'image',
						'title'       => esc_attr__('Images Three', 'tmte'),
						'add_title'   => 'Add Images',
						'edit_title'  => 'Edit Images',
						'clear_title' => 'Remove Images',
						'dependency'  => array( 'featuredtype_multiimage', '==', 'true' ),
						'after'       => '<br><div class="cs-text-muted">'.__('Select 3rd image', 'tmte').'</div>',
					),
	...
	$options[]    = array(
		'id'        => 'preyantechnosys_portfolio_view',
		'title'     => sprintf( esc_attr__('Minemo: %s View Style', 'tmte'), $pf_type_title_singular ),
		'post_type' => 'tm_portfolio', // only here is important
		'context'   => 'normal',
		'priority'  => 'default',
		'sections'  => array(
			array(
				'name'   => 'preyantechnosys_pf_view',
				'fields' => array(
	...
	$options[]    = array(
		'id'        => 'preyantechnosys_portfolio_like',
		'title'     => esc_attr__('Minemo: Portfolio Like Option','tmte'),
		'post_type' => 'tm_portfolio', // only here is important
		'context'   => 'normal',
		'priority'  => 'default',
		'sections'  => array(
			array(
				'name'   => 'preyantechnosys_portfolio_resetlike',
				'fields' => array(
...
add_filter( 'cs_metabox_options', 'preyantechnosys_minemo_tm_portfolio_metabox_options' );