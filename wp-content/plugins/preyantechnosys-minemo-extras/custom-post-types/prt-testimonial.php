...
function preyantechnosys_minemo_cpt_tm_testimonial(){
	...
	function preyantechnosys_minemo_tm_testimonial_enter_title_here( $title ){
	...
	add_filter( 'enter_title_here', 'preyantechnosys_minemo_tm_testimonial_enter_title_here' );


	// Move Featured Image box from left to center only on CLIENTS custom_post_type
	add_action('do_meta_boxes', 'preyantechnosys_minemo_tm_testimonial_featured_image_box');
	function preyantechnosys_minemo_tm_testimonial_featured_image_box() {
...
add_action( 'init', 'preyantechnosys_minemo_cpt_tm_testimonial', 8 );
...
add_filter( 'manage_tm_testimonial_posts_columns', 'preyantechnosys_tm_testimonial_tm_testimonial_set_featured_image_column' );
add_action( 'manage_tm_testimonial_posts_custom_column' , 'preyantechnosys_tm_testimonial_set_featured_image_column_content', 10, 2 );
if ( ! function_exists( 'preyantechnosys_tm_testimonial_tm_testimonial_set_featured_image_column' ) ) {
function preyantechnosys_tm_testimonial_tm_testimonial_set_featured_image_column($columns) {
	$new_columns = array();
...
if ( ! function_exists( 'preyantechnosys_tm_testimonial_set_featured_image_column_content' ) ) {
function preyantechnosys_tm_testimonial_set_featured_image_column_content( $column, $post_id ) {
 ...
 *  Meta Box: Clients
 */
if ( ! function_exists( 'preyantechnosys_minemo_tm_testimonials_metabox_options' ) ) {
function preyantechnosys_minemo_tm_testimonials_metabox_options( $options ) {
	

	
	// Client Details Meta Box
	$options[]    = array(
		'id'        => 'preyantechnosys_testimonials_details',
		'title'     => esc_attr__('Minemo: Testimonial Details', 'tmte'),
		'post_type' => 'tm_testimonial', // only here is important
		'context'   => 'normal',
		'priority'  => 'default',
		'sections'  => array(
			array(
				'name'   => 'preyantechnosys_testi_details',
				'fields' => array(
...
add_filter( 'cs_metabox_options', 'preyantechnosys_minemo_tm_testimonials_metabox_options' );
