...
$footer_col = '3_3_3_3';
if( !empty($minemo_theme_options['first_footer_column_layout']) ){
	$footer_col = esc_attr($minemo_theme_options['first_footer_column_layout']);
}
?>
...
<div id="first-footer" class="sidebar-container first-footer <?php echo preyantechnosys_sanitize_html_classes(preyantechnosys_footer_row_class( 'first' )); ?>" role="complementary">
