...
get_header(); ?>
	...
	<section id="primary" class="content-area <?php echo preyantechnosys_sanitize_html_classes(preyantechnosys_sidebar_class('content-area')); ?>">
		...
		<?php if ( have_posts() ) : ?>
			...
			$view   = ( !empty($minemo_theme_options['teamcat_view']) ) ? $minemo_theme_options['teamcat_view'] : 'top-image' ;
			$column = ( !empty($minemo_theme_options['teamcat_column']) ) ? $minemo_theme_options['teamcat_column'] : 'three' ;
