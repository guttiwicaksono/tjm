...
class Minemo_Blogbox_Widget extends Widget_Base{
	...
	public function get_title() {
		return esc_attr__( 'Blog Box', 'minemo' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Blogbox Style', 'minemo' ),
				'description'	=> esc_attr__( 'Select Blogbox style.', 'minemo' ),
				'type' => Controls_Manager::SELECT,
				'label_block'	=> true,
				'options' => [
					'style1'	=> esc_attr( 'BlogBox Style 1' ),
					'style2'	=> esc_attr( 'BlogBox Style 2' ),
					'style3'	=> esc_attr( 'BlogBox Style 3' ),
					'style4'	=> esc_attr( 'BlogBox Style 4' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_attr__( 'Latest News', 'minemo' ),
		...
		$this->add_control(
			'exclude_posts',
			[
				'label' => esc_attr__( 'Exclude Posts', 'minemo' ),
				'description' => esc_attr__( 'Exclude posts that you don\'t want to appear. Write ID of the post with comma separated. Example "10,11,15".', 'minemo' ),
		...
		if ( $posts->have_posts() ) {
			...
			<div class="preyantechnosys-box-heading-wrapper <?php echo preyantechnosys_wp_kses($headingclass); ?>">
				...
				if( function_exists('preyantechnosys_get_filterbutton') ){
					$sortable_category_html = preyantechnosys_get_filterbutton( $settings, 'category' );
...
// Register widget
Plugin::instance()->widgets_manager->register( new Minemo_Blogbox_Widget() );