...
class Minemo_Teambox_Widget extends Widget_Base{
	...
	public function get_title() {
		return esc_attr__( 'Team Box', 'minemo' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Teambox Style', 'minemo' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_attr__( 'Our Team', 'minemo' ),
		...
		if ( $posts->have_posts() ) {
			...
			<div class="preyantechnosys-box-heading-wrapper <?php echo preyantechnosys_wp_kses($headingclass); ?>">
				...
				if( function_exists('preyantechnosys_get_filterbutton') ){
					$sortable_category_html = preyantechnosys_get_filterbutton( $settings, 'tm_team_group' );
...
// Register widget
Plugin::instance()->widgets_manager->register( new Minemo_Teambox_Widget() );