...
class Minemo_Clientbox_Widget extends Widget_Base{
	...
	public function get_title() {
		return esc_attr__( 'Client Logo Box', 'minemo' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Client View Style', 'minemo' ),
				'description'	=> esc_attr__( 'Select Client View style.', 'minemo' ),
				'type' => Controls_Manager::SELECT,
				'label_block'	=> true,
				'options' => [
					'simple-logo'		=> esc_attr( 'Simple Logo view' ),
					'simple-logo2'		=> esc_attr( 'Simple Logo view2' ),
		...
		$this->start_controls_section(
			'data_section',
			[
				'label' => esc_attr__( 'Data Design', 'minemo' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_attr__( 'How many Post you want to show.', 'minemo' ),
				'separator' => 'before',
		...
		$this->add_control(
			...
			[
				...
				'options'		=> [
					...
					'seven'				=> esc_attr__( 'Seven Column', 'minemo' ),
					'eight'				=> esc_attr__( 'Eight Column', 'minemo' ),
				],
			]
		);
		...
		$this->add_control(
			'prt-speed',
			[
				'label'			=> esc_attr__( 'Carousel: Speed', 'minemo' ),
				'description'	=> esc_attr__( 'Carousel Effect: Slide/Fade speed.', 'minemo' ),
		...
		$this->add_control(
			'prt-rtl',
			[
				'label'			=> esc_attr__( 'Carousel: RTL', 'minemo' ),
				'description'	=> esc_attr__( 'Carousel Effect: RTL sliding.', 'minemo' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> 'false',
				'options'		=> [
					'true'				=> esc_attr__( 'True', 'minemo' ),
					'false'				=> esc_attr__( 'False', 'minemo' ),
				],
				'condition'		=> [
					'view-type'		=> 'carousel',
				]
		...
		$this->add_control(
			'prt-cssease',
			[
				'label'			=> esc_attr__( 'Carousel: cssEase', 'minemo' ),
				'description'	=> esc_attr__( 'Carousel Effect: cssEase sliding.', 'minemo' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> 'none',
				'options'		=> [
					'linear'				=> esc_attr__( 'Linear', 'minemo' ),
					'ease'				=> esc_attr__( 'Ease', 'minemo' ),
...
// Register widget
Plugin::instance()->widgets_manager->register( new Minemo_Clientbox_Widget() );