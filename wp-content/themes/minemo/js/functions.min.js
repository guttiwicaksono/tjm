...
jQuery('.menu-toggle').on('click.minemo',function(){nav.toggleClass('toggled-on')})})();jQuery('#site-header-menu #site-navigation div.nav-menu > ul > li:has(ul), .prt-mmmenu-override-yes #site-header-menu #site-navigation .mega-menu-wrap > ul > li:has(ul)').append("<span class='righticon'><i class='prt-minemo-icon-angle-down'></i></span>");jQuery('.righticon').on('click',function(){if(jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').hasClass('open')){jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').removeClass('open');jQuery('i',jQuery(this)).removeClass('prt-minemo-icon-angle-up').addClass('prt-minemo-icon-angle-down')}else{jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').addClass('open');jQuery('i',jQuery(this)).removeClass('prt-minemo-icon-angle-down').addClass('prt-minemo-icon-angle-up')}
