...
<div class="preyantechnosys-iconbox preyantechnosys-iconbox-<?php echo esc_attr($boxstyle); ?> <?php echo esc_attr($mainclass); ?> preyantechnosys-iconbgcolor-<?php echo esc_attr($icon_bgcolor_html); ?> preyantechnosys-iconcolor-<?php echo esc_attr($icon_color_html); ?> preyantechnosys-iconsize-<?php echo esc_attr($icon_size_html); ?> preyantechnosys-iconshape-<?php echo esc_attr($icon_shape_html); ?>">
...
<div class="preyantechnosys-iconbox-inner">
		<div class="prt-iconbox-wrapper">
			...
			<div class="preyantechnosys-iconbox-desc">
