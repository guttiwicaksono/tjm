<header id="masthead" class="prt-header-style-classic<?php echo preyantechnosys_header_style_class(); ?>">
	<div class="prt-header-block <?php echo preyantechnosys_headerclass(); ?>">
