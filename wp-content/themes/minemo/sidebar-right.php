...
if( is_page() ){
	...
	$sidebar_right_page = get_post_meta( get_the_ID(), '_preyantechnosys_metabox_sidebar', true );
	...
	if( $post_id ){
		$sidebar_right_page = get_post_meta( $post_id, '_preyantechnosys_metabox_sidebar', true );
		if( !empty($sidebar_right_page['right_sidebar']) ){ $sidebar_right = $sidebar_right_page['right_sidebar']; }
	}
