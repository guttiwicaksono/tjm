...
if( is_page() ){
	...
	$sidebar_left_page = get_post_meta( get_the_ID(), '_preyantechnosys_metabox_sidebar', true );
	...
	if( $post_id ){
		$sidebar_left_page = get_post_meta( $post_id, '_preyantechnosys_metabox_sidebar', true );
		if( !empty($sidebar_left_page['left_sidebar']) ){ $sidebar_left = $sidebar_left_page['left_sidebar']; }
	}
	...
	$sidebar_left_blog = get_post_meta( $pageid ,'_preyantechnosys_'.$postType.'_options_leftsidebar',true);
	...
	$sidebar_left = esc_attr($minemo_theme_options['sidebar_post']); // Global settings
	$sidebar_left = 'sidebar-left-blog';
	$sidebar_left_post = get_post_meta($post->ID,'_preyantechnosys_post_options_leftsidebar',true);
